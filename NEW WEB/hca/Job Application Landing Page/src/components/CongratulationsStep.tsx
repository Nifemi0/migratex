    ...
    <div className="space-y-8 animate-fade-in text-center">
      ...
      <div className="flex flex-col items-center justify-center space-y-4 py-8">
        ...
        <div className="space-y-2">
          <h2 className="text-3xl font-display font-black text-secondary tracking-tighter uppercase whitespace-pre-line">
            Application <br /><span className="text-primary">Submitted Successfully</span>
          </h2>
          <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">
            Official Candidate Registry Entry
          </p>
        </div>
      </div>
